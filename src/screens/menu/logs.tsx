                ...
                >
                    ...
                    <Cluster>
                        <View style={{ padding: 12 }}>
                            <Text style={{ ...T.text25, color: theme.textColor }}>Logs</Text>
                            <Space height={6} />
                            <Text style={{ ...T.text15, color: theme.oppositeTextColor }}>
                                Review container and host log sources directly from the app.
                            </Text>
                        </View>
                    </Cluster>
                    <Space height={10} />
                                ...
                                <View style={{ padding: 12 }}>
                                    ...
                                    {source.entries.slice(0, 6).map(entry => (
                                        <View key={`${source.id}-${entry.fingerprint}`} style={{
                                            ...
                                            <Text style={{ ...T.text12, color: entry.isError ? "#ff8b8b" : theme.oppositeTextColor }}>
