...
import { getSafeMusicActivity } from '@utils/discovery/discoveryApi'
                        ...
                        <>
                            ...
                            <Cluster>
                                <View style={{ padding: 12, flexDirection: 'row', flexWrap: 'wrap', gap: 10 }}>
                                    ...
                                    <StatCard
                                        label={text.stats.thisYear}
                                        value={formatNumber(data.stats.total_minutes_this_year)}
                                    />
                                    <StatCard label={text.stats.songsPlayed} value={formatNumber(data.stats.total_songs)} />
                                    <StatCard
                                        label={text.stats.averageLength}
                                        value={`${Math.round(data.stats.avg_seconds / 60)} ${text.stats.minutesShort}`}
                                    />
                                </View>
                            </Cluster>
                            <Space height={10} />
