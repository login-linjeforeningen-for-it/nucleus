                ...
                >
                    ...
                    <Cluster>
                        <View style={{ padding: 12 }}>
                            <Text style={{ ...T.text25, color: theme.textColor }}>Databases</Text>
                            <Space height={6} />
                            <Text style={{ ...T.text15, color: theme.oppositeTextColor }}>
                                Database clusters, size, connections, and active query pressure.
                            </Text>
                        </View>
                    </Cluster>
                    {!!error && (
                            ...
                            <Cluster>
                                <View style={{ padding: 12, flexDirection: "row", flexWrap: "wrap", gap: 10 }}>
                                    ...
                                    <View style={{ flexBasis: "47%", flexGrow: 1 }}>
                                        ...
                                        <Text style={{ ...T.text20, color: theme.textColor }}>{formatBytes(data.totalSizeBytes)}</Text>
                                    </View>
                                </View>
                            </Cluster>
                            <Space height={10} />
                                ...
                                <View key={cluster.id}>
                                    <Cluster>
                                        <View style={{ padding: 12 }}>
                                            ...
                                            <Space height={4} />
                                            <Text style={{ ...T.text15, color: theme.oppositeTextColor }}>
                                                {cluster.databaseCount} databases · {cluster.activeQueries} active queries · {formatBytes(cluster.totalSizeBytes)}
                                            </Text>
                                            {cluster.longestQuery?.query && (
                                                <>
                                                    <Space height={8} />
                                                    <Text style={{ ...T.text12, color: theme.oppositeTextColor }}>Longest query</Text>
                                                    <Space height={4} />
                                                    <Text style={{ ...T.text15, color: theme.textColor }}>{cluster.longestQuery.query}</Text>
                                                </>
                                            )}
                                        </View>
                                    </Cluster>
