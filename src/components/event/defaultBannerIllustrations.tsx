...
export function TekkomBanner({ fill }: BannerProps) {
    return (
...
export function CtfBanner({ fill }: BannerProps) {
    return (
        <Svg width='100%' height='100%' viewBox='0 0 500 200'>
...
export function SocialBanner({ fill }: BannerProps) {
    return (
        <Svg width='100%' height='100%' viewBox='0 0 500 200'>
...
export function BedpresBanner({ fill }: BannerProps) {
    return (
        <Svg width='100%' height='100%' viewBox='0 0 500 200'>
...
export function EventBanner({ fill }: BannerProps) {
    return (
        <Svg width='100%' height='100%' viewBox='0 0 500 200'>
